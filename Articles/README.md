...
- [Code coverage using Eclipse, GNU ARM toolchain, and Gcov for embedded systems](https://technfoblog.wordpress.com/2016/11/05/code-coverage-using-eclipse-gnu-arm-toolchain-and-gcov-for-embedded-systems/)

- [Modified Condition/Decision Coverage](https://www.rapitasystems.com/mcdc-coverage)

- [Introduction to `gcov`](https://gcc.gnu.org/onlinedocs/gcc/Gcov-Intro.html#Gcov-Intro)
